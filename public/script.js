...
function showRegistrationReminder() {
...
// Ваші інші функції (login, addUser, blockUser тощо) залишаються без змін
function login() {
...
// Інші функції для додавання користувача, блокування і т.д.
// Викликаємо функцію показу нагадування після кожного запуску
showRegistrationReminder();
function login() {
  const username = document.getElementById('username').value;
  const password = document.getElementById('password').value;
